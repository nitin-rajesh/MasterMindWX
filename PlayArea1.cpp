...
PlayArea1::PlayArea1(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	Connect(ID_CHOICE1,wxEVT_COMMAND_CHOICE_SELECTED,(wxObjectEventFunction)&PlayArea1::numberOfColumns);
	Connect(ID_RADIOBUTTON1,wxEVT_COMMAND_RADIOBUTTON_SELECTED,(wxObjectEventFunction)&PlayArea1::RepititionBool);
	Connect(ID_CHOICE2,wxEVT_COMMAND_CHOICE_SELECTED,(wxObjectEventFunction)&PlayArea1::numberOfColours);
